...
<div class="container-fluid" style="height:10px; background:#303f9f"></div>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-cstom">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="#"><i class="fa-solid fa-book-bookmark"></i> Old Book</a>
        </li>
      </ul>
